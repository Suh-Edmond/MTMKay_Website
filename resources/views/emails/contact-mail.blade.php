...
<div style="background-color: #e2e8f0;">
    <div style="display: flex;justify-content: center;padding: 10px">
        <span style="display: flex; justify-content: center;font-weight: bold;margin-left: 2px"><a href="{{config('APP_URL')}}" style="text-decoration: none">MTMKay Technology Solutions Ltd</a></span><br>
    </div>
